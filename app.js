...
const {DATABASE_NAME, APPLICATION_COLLECTION, USER_COLLECTION, LOG_COLLECTION, APPROVED_STUDIES_COLLECTION, SUBMISSION_COLLECTION,BATCH_COLLECTION} = require("./crdc-datahub-database-drivers/database-constants");
