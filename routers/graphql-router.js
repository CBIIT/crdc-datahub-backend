...
dbConnector.connect().then(() => {
    ...
    const notificationTime = {inactiveDays: config.inactive_user_days, inactiveApplicationDay: config.inactive_application_days, remindDay: config.remind_application_days};
    const emailParams = {url: config.emails_url, officialEmail: config.official_email, ...notificationTime};
