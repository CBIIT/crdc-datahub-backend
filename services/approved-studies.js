...
class ApprovedStudiesService {
    ...
    async editApprovedStudyAPI(params, context) {
        ...
        const isPendingDbGaPID = isTrue(updateStudy.controlledAccess) ? !Boolean(updateStudy?.dbGaPID) : false;
        const hasPendingGPA = isTrue(updateStudy.controlledAccess) ? Boolean(updateStudy?.isPendingGPA) : false;
        const allPendingsCleared = !isTrue(updateStudy?.pendingModelChange) && !hasPendingGPA && !isPendingDbGaPID;
