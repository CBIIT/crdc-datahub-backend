...
class UserNotifications {
        ...
        switch (role) {
            ...
            case USER.ROLES.ADMIN:
                return [EMAIL_NOTIFICATIONS.SUBMISSION_REQUEST.REQUEST_READY_REVIEW, EMAIL_NOTIFICATIONS.SUBMISSION_REQUEST.REQUEST_REVIEW, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.CANCEL,
                    EMAIL_NOTIFICATIONS.DATA_SUBMISSION.RELEASE, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.COMPLETE, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.REMIND_EXPIRE,
                    EMAIL_NOTIFICATIONS.DATA_SUBMISSION.DELETE, EMAIL_NOTIFICATIONS.USER_ACCOUNT.REQUEST_ACCESS];
            case USER.ROLES.SUBMITTER:
                return [EMAIL_NOTIFICATIONS.SUBMISSION_REQUEST.REQUEST_REVIEW, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.SUBMIT, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.CANCEL,
                    ...
                    EMAIL_NOTIFICATIONS.DATA_SUBMISSION.REMIND_EXPIRE, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.DELETE, EMAIL_NOTIFICATIONS.USER_ACCOUNT.REQUEST_ACCESS];
            default:
                // For USER.ROLES.USER:
                return [EMAIL_NOTIFICATIONS.SUBMISSION_REQUEST.REQUEST_REVIEW, EMAIL_NOTIFICATIONS.USER_ACCOUNT.REQUEST_ACCESS];
        }
    }
    ...
    #getBannedNotificationsByRole(role) {
        switch (role) {
            case USER.ROLES.FEDERAL_LEAD:
            case USER.ROLES.DATA_COMMONS_PERSONNEL:
                return [EMAIL_NOTIFICATIONS.USER_ACCOUNT.REQUEST_ACCESS, EMAIL_NOTIFICATIONS.USER_ACCOUNT.USER_INACTIVATED_ADMIN];
            case USER.ROLES.ADMIN:
                return [EMAIL_NOTIFICATIONS.USER_ACCOUNT.USER_INACTIVATED];
            default:
                return [];
        }
    }
