...
class UserService {
    ...
    #validateUserPermission(permissions, notifications) {
        ...
        if (notifications) {
            const allEmailNotificationNames = [...Object.values(EMAIL_NOTIFICATIONS.SUBMISSION_REQUEST), ...Object.values(EMAIL_NOTIFICATIONS.DATA_SUBMISSION)];
...
class UserActionPermissions {
    ...
    #getDefaultPermissionsByRole() {
        switch (this.role) {
            ...
            case USER.ROLES.ADMIN:
                return [SUBMISSION_REQUEST.VIEW, DATA_SUBMISSION.VIEW, DATA_SUBMISSION.CREATE, ADMIN.REQUEST_ACCESS];
            case USER.ROLES.SUBMITTER:
                return [SUBMISSION_REQUEST.CREATE, DATA_SUBMISSION.VIEW, DATA_SUBMISSION.CREATE, ADMIN.REQUEST_ACCESS];
            default:
                // For USER.ROLES.USER:
                return [SUBMISSION_REQUEST.CREATE, ADMIN.REQUEST_ACCESS];
        }
    }
    ...
    #getBannedPermissionsByRole() {
        switch (this.role) {
            case USER.ROLES.FEDERAL_LEAD:
                return [DATA_SUBMISSION.ADMIN_SUBMIT, ADMIN.REQUEST_ACCESS];
            case USER.ROLES.DATA_COMMONS_PERSONNEL:
                return [SUBMISSION_REQUEST.VIEW, DATA_SUBMISSION.VIEW, DATA_SUBMISSION.CREATE, ADMIN.REQUEST_ACCESS, ADMIN.MANAGE_USER];
            default:
                return [];
        }
    }
...
class UserNotifications {
    ...
    #getDefaultNotificationsByRole(role) {
        switch (role) {
            case USER.ROLES.FEDERAL_LEAD:
                return [EMAIL_NOTIFICATIONS.SUBMISSION_REQUEST.REQUEST_READY_REVIEW];
            case USER.ROLES.DATA_COMMONS_PERSONNEL:
                return [EMAIL_NOTIFICATIONS.DATA_SUBMISSION.SUBMIT, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.CANCEL, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.WITHDRAW,
                    EMAIL_NOTIFICATIONS.DATA_SUBMISSION.RELEASE, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.COMPLETE, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.REMIND_EXPIRE,
                    EMAIL_NOTIFICATIONS.DATA_SUBMISSION.DELETE
                ];
            case USER.ROLES.ADMIN:
                return [EMAIL_NOTIFICATIONS.SUBMISSION_REQUEST.REQUEST_READY_REVIEW, EMAIL_NOTIFICATIONS.SUBMISSION_REQUEST.REQUEST_REVIEW, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.CANCEL,
                    EMAIL_NOTIFICATIONS.DATA_SUBMISSION.RELEASE, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.COMPLETE, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.REMIND_EXPIRE,
                    EMAIL_NOTIFICATIONS.DATA_SUBMISSION.DELETE, ADMIN.REQUEST_ACCESS];
            case USER.ROLES.SUBMITTER:
                return [EMAIL_NOTIFICATIONS.SUBMISSION_REQUEST.REQUEST_REVIEW, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.SUBMIT, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.CANCEL,
                    EMAIL_NOTIFICATIONS.DATA_SUBMISSION.WITHDRAW, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.RELEASE, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.COMPLETE,
                    EMAIL_NOTIFICATIONS.DATA_SUBMISSION.REMIND_EXPIRE, EMAIL_NOTIFICATIONS.DATA_SUBMISSION.DELETE, ADMIN.REQUEST_ACCESS];
            default:
                // For USER.ROLES.USER:
                return [EMAIL_NOTIFICATIONS.SUBMISSION_REQUEST.REQUEST_REVIEW, ADMIN.REQUEST_ACCESS];
        }
    }
